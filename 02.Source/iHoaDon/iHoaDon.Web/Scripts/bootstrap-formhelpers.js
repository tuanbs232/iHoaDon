...
var BFHCurrenciesList = {
  'AED':{'label':'Dirham Các tiểu vương quốc Ả Rập thống nhất','currencyflag':'','symbol':'Ø¯.Ø¥'},
  'AFN':{'label':'Afghani Afghanistan','currencyflag':'','symbol':'Ø‹'},
  'ALL':{'label':'Lek Albani','currencyflag':'','symbol':'L'},
  'AMD':{'label':'Dram Armenia','currencyflag':'','symbol':'Õ¤Ö€'},
  'AOA':{'label':'Kwanza Angola','currencyflag':'','symbol':'Kz'},
  'ARS':{'label':'Peso Argentina','currencyflag':'','symbol':'$'},
  'AUD':{'label':'Đô la Australia','currencyflag':'AUD','symbol':'$'},
  'AWG':{'label':'Florin Aruba','currencyflag':'','symbol':'Æ’'},
  'AZN':{'label':'Manat Azerbaijan','currencyflag':'','symbol':''},
  'BAM':{'label':'Mark Bosnia và Herzegovina','currencyflag':'','symbol':'KM'},
  'BBD':{'label':'Đô la Barbadi','currencyflag':'','symbol':'$'},
  'BDT':{'label':'Taka Banglades','currencyflag':'','symbol':'à§³'},
  'BGN':{'label':'Lev Bulgari','currencyflag':'','symbol':'Ð»Ð²'},
  'BHD':{'label':'Dinar Bahrain','currencyflag':'','symbol':'.Ø¯.Ø¨'},
  'BIF':{'label':'Franc Burundi ','currencyflag':'','symbol':'Fr'},
  'BMD':{'label':'Đô la Bermuda','currencyflag':'','symbol':'$'},
  'BND':{'label':'Đô la Brunei','currencyflag':'','symbol':'$'},
  'BOB':{'label':'Boliviano Bolivia','currencyflag':'','symbol':'Bs'},
  'BRL':{'label':'Real Brazil','currencyflag':'','symbol':'R$'},
  'BSD':{'label':'Đô la Bahamás','currencyflag':'','symbol':'$'},
  'BTN':{'label':'Ngultrum Bhutan','currencyflag':'','symbol':'Nu'},
  'BWP':{'label':'Pula Botswana','currencyflag':'','symbol':'P'},
  'BYR':{'label':'Ruble Belarus','currencyflag':'','symbol':'Br'},
  'BZD':{'label':'Đô la Belize','currencyflag':'','symbol':'$'},
  'CAD':{'label':'Đô la Canada','currencyflag':'','symbol':'$'},
  'CDF':{'label':'Franc Công Gô','currencyflag':'','symbol':'Fr'},
  'CHF':{'label':'Franc Thụy Sĩ','currencyflag':'CHF','symbol':'Fr'},
  'CLP':{'label':'Peso Chile','currencyflag':'','symbol':'$'},
  'CNY':{'label':'Nhân dân tệ Trung Quốc','currencyflag':'','symbol':'Â¥'},
  'COP':{'label':'Peso Colombia','currencyflag':'','symbol':'$'},
  'CRC':{'label':'Colón Costa Rica','currencyflag':'','symbol':'â‚¡'},
  'CUP':{'label':'Peso Cuba','currencyflag':'','symbol':'$'},
  'CVE':{'label':'Escudo Cape Verde','currencyflag':'','symbol':'$'},
  'CZK':{'label':'Koruna Cộng hòa Czech','currencyflag':'','symbol':'KÄ�'},
  'DJF':{'label':'Franc Djibouti','currencyflag':'','symbol':'Fr'},
  'DKK':{'label':'Krone Đan Mạch','currencyflag':'DKK','symbol':'kr'},
  'DOP':{'label':'Peso Dominica','currencyflag':'','symbol':'$'},
  'DZD':{'label':'Dinar Algeria','currencyflag':'','symbol':'Ø¯.Ø¬'},
  'EGP':{'label':'Pound Ai Cập','currencyflag':'','symbol':'Ø¬.Ù…'},
  'ERN':{'label':'Nakfa Eritrea','currencyflag':'','symbol':'Nfk'},
  'ETB':{'label':'Birr Ethiopia','currencyflag':'','symbol':'Br'},
  'EUR':{'label':'Euro','currencyflag':'EUR','symbol':'â‚¬'},
  'FJD':{'label':'Đô la Fiji','currencyflag':'','symbol':'$'},
  'FKP':{'label':'Pound Quần đảo Falkland','currencyflag':'','symbol':'Â£'},
  'GBP':{'label':'Bảng Anh','currencyflag':'','symbol':'Â£'},
  'GEL':{'label':'Lari Georgia','currencyflag':'','symbol':'áƒš'},
  'GHS':{'label':'Cedi Ghana','currencyflag':'','symbol':'â‚µ'},
  'GMD':{'label':'Dalasi Gambia','currencyflag':'','symbol':'D'},
  'GNF':{'label':'Franc Guinea','currencyflag':'','symbol':'Fr'},
  'GTQ':{'label':'Duetzal Guatemala','currencyflag':'','symbol':'Q'},
  'GYD':{'label':'Đô la Guyana','currencyflag':'','symbol':'$'},
  'HKD':{'label':'Đô la Hồng Kông','currencyflag':'','symbol':'$'},
  'HNL':{'label':'Lempira Honduras','currencyflag':'','symbol':'L'},
  'HRK':{'label':'Kuna Croatia','currencyflag':'','symbol':'kn'},
  'HTG':{'label':'Gourde Haiti','currencyflag':'','symbol':'G'},
  'HUF':{'label':'Forint Hungaria','currencyflag':'','symbol':'Ft'},
  'IDR':{'label':'Rupiah Indonesia','currencyflag':'','symbol':'Rp'},
  'ILS':{'label':'New shekel Israel','currencyflag':'','symbol':'â‚ª'},
  'IMP':{'label':'Pound Manx','currencyflag':'','symbol':'Â£'},
  'INR':{'label':'Rupee Ấn Độ','currencyflag':'','symbol':''},
  'IQD':{'label':'Dinar Iraq','currencyflag':'','symbol':'Ø¹.Ø¯'},
  'IRR':{'label':'Rial Iran','currencyflag':'','symbol':'ï·¼'},
  'ISK':{'label':'Króna Iceland','currencyflag':'','symbol':'kr'},
  'JEP':{'label':'Pound Jersey','currencyflag':'','symbol':'Â£'},
  'JMD':{'label':'Đô la Jamaica','currencyflag':'','symbol':'$'},
  'JOD':{'label':'Dinar Jordania','currencyflag':'','symbol':'Ø¯.Ø§'},
  'JPY':{'label':'Yên Nhật','currencyflag':'','symbol':'Â¥'},
  'KES':{'label':'Shilling Kenya','currencyflag':'','symbol':'Sh'},
  'KGS':{'label':'Som Kyrgyzstan','currencyflag':'','symbol':'Ð»Ð²'},
  'KHR':{'label':'Riel Campuchia','currencyflag':'','symbol':'áŸ›'},
  'KMF':{'label':'Franc Coromo','currencyflag':'','symbol':'Fr'},
  'KPW':{'label':'Won Bắc Triều Tiên','currencyflag':'','symbol':'â‚©'},
  'KRW':{'label':'Won Hàn Quốc','currencyflag':'','symbol':'â‚©'},
  'KWD':{'label':'Dinar Kuwait','currencyflag':'','symbol':'Ø¯.Ùƒ'},
  'KYD':{'label':'Đô la Quần đảo Cayman','currencyflag':'','symbol':'$'},
  'KZT':{'label':'Tenge Kazakhstan','currencyflag':'','symbol':'â‚¸'},
  'LAK':{'label':'Kip Lào','currencyflag':'','symbol':'â‚­'},
  'LBP':{'label':'Pound Leban','currencyflag':'','symbol':'Ù„.Ù„'},
  'LKR':{'label':'Rupee Sri Lanka','currencyflag':'','symbol':'Rs'},
  'LRD':{'label':'Đô la Liberia','currencyflag':'','symbol':'$'},
  'LSL':{'label':'Loti Lesotho','currencyflag':'','symbol':'L'},
  'LTL':{'label':'Litas Lithuania','currencyflag':'','symbol':'Lt'},
  'LVL':{'label':'Lats Latvia','currencyflag':'','symbol':'Ls'},
  'LYD':{'label':'Dinar Liby','currencyflag':'','symbol':'Ù„.Ø¯'},
  'MAD':{'label':'Dirham Marốc','currencyflag':'','symbol':'Ø¯.Ù….'},
  'MDL':{'label':'Leu Moldova','currencyflag':'','symbol':'L'},
  'MGA':{'label':'Ariary Madagascar','currencyflag':'','symbol':'Ar'},
  'MKD':{'label':'Denar Macedonia','currencyflag':'','symbol':'Ð´ÐµÐ½'},
  'MMK':{'label':'Kyat Myanmar','currencyflag':'','symbol':'Ks'},
  'MNT':{'label':'Tögrög Mongolia','currencyflag':'','symbol':'â‚®'},
  'MOP':{'label':'Pataca Macau','currencyflag':'','symbol':'P'},
  'MRO':{'label':'Ouguiya Mauritania','currencyflag':'','symbol':'UM'},
  'MUR':{'label':'Rupee Mauritius','currencyflag':'','symbol':'Rs'},
  'MVR':{'label':'Rufiyaa Maldives','currencyflag':'','symbol':'.Þƒ'},
  'MWK':{'label':'Kwacha Malawi','currencyflag':'','symbol':'MK'},
  'MXN':{'label':'Peso Mexico','currencyflag':'','symbol':'$'},
  'MYR':{'label':'Ringgit Malaysia','currencyflag':'','symbol':'MR'},
  'MZN':{'label':'Metical Mozambic','currencyflag':'','symbol':'MT'},
  'NAD':{'label':'Đô la Namibia','currencyflag':'','symbol':'$'},
  'NGN':{'label':'Naira Nigeria','currencyflag':'','symbol':'â‚¦'},
  'NIO':{'label':'Córdoba Nicaragua','currencyflag':'','symbol':'C$'},
  'NOK':{'label':'Krone Na Uy','currencyflag':'','symbol':'kr'},
  'NPR':{'label':'Rupee Nepal','currencyflag':'','symbol':'Rs'},
  'NZD':{'label':'Đô la New Zealand','currencyflag':'','symbol':'$'},
  'OMR':{'label':'Rial Omani','currencyflag':'','symbol':'Ø±.Ø¹.'},
  'PAB':{'label':'Balboa Panama','currencyflag':'','symbol':'B/.'},
  'PEN':{'label':'Nuevo sol Peru','currencyflag':'','symbol':'S/.'},
  'PGK':{'label':'Kina Papua New Guinea','currencyflag':'','symbol':'K'},
  'PHP':{'label':'Peso Philippin','currencyflag':'','symbol':'â‚±'},
  'PKR':{'label':'Rupee Pakistan','currencyflag':'','symbol':'Rs'},
  'PLN':{'label':'Złoty Ba Lan','currencyflag':'','symbol':'zÅ‚'},
  'PRB':{'label':'Ruble Transnistria','currencyflag':'','symbol':'Ñ€.'},
  'PYG':{'label':'Guaraní Paraguay','currencyflag':'','symbol':'â‚²'},
  'QAR':{'label':'Riyal Qatar','currencyflag':'','symbol':'Ø±.Ù‚'},
  'RON':{'label':'Leu Romani','currencyflag':'','symbol':'L'},
  'RSD':{'label':'Dinar Serbia','currencyflag':'','symbol':'Ð´Ð¸Ð½'},
  'RUB':{'label':'Ruble Nga','currencyflag':'','symbol':'Ñ€ÑƒÐ±.'},
  'RWF':{'label':'Franc Rwandan','currencyflag':'','symbol':'Fr'},
  'SAR':{'label':'Riyal Saudi','currencyflag':'','symbol':'Ø±.Ø³'},
  'SBD':{'label':'Đô la Quần đảo Solomon','currencyflag':'','symbol':'$'},
  'SCR':{'label':'Rupee Seychellois','currencyflag':'','symbol':'Rs'},
  'SDG':{'label':'Đô la Sudan','currencyflag':'','symbol':'$'},
  'SEK':{'label':'Krona Thụy Điển','currencyflag':'','symbol':'kr'},
  'SGD':{'label':'Đô la Singapore','currencyflag':'','symbol':'$'},
  'SHP':{'label':'Pound Saint Helena','currencyflag':'','symbol':'Â£'},
  'SLL':{'label':'Leone Sierra Leonean','currencyflag':'','symbol':'Le'},
  'SOS':{'label':'Shilling Somali','currencyflag':'','symbol':'Sh'},
  'SRD':{'label':'Đô la Surinam','currencyflag':'','symbol':'$'},
  'SSP':{'label':'Pound Nam Sudan','currencyflag':'','symbol':'Â£'},
  'STD':{'label':'Dobra São Tomé và Príncipe','currencyflag':'','symbol':'Db'},
  'SVC':{'label':'Colón Salvador','currencyflag':'','symbol':'â‚¡'},
  'SYP':{'label':'Pound Syri','currencyflag':'','symbol':'Â£'},
  'SZL':{'label':'Lilangeni Swazi','currencyflag':'','symbol':'L'},
  'THB':{'label':'Baht Thái Lan','currencyflag':'','symbol':'à¸¿'},
  'TJS':{'label':'Somoni Tajikistan','currencyflag':'','symbol':'SM'},
  'TMT':{'label':'Manat Turkmenistan','currencyflag':'','symbol':'m'},
  'TND':{'label':'Dinar Tunisi','currencyflag':'','symbol':'Ø¯.Øª'},
  'TOP':{'label':'Paʻanga Tonga','currencyflag':'','symbol':'T$'},
  'TRY':{'label':'Lira Thổ Nhĩ Kì','currencyflag':'','symbol':'&#8378;'},
  'TTD':{'label':'Đô la Trinidad và Tobago','currencyflag':'','symbol':'$'},
  'TWD':{'label':'Đô la Đài Loan','currencyflag':'','symbol':'$'},
  'TZS':{'label':'Shilling Tanzania','currencyflag':'','symbol':'Sh'},
  'UAH':{'label':'Hryvnia Ukraina','currencyflag':'','symbol':'â‚´'},
  'UGX':{'label':'Shilling Uganda','currencyflag':'','symbol':'Sh'},
  'USD':{'label':'Đô la Mỹ','currencyflag':'','symbol':'$'},
  'UYU':{'label':'Peso Uruguay','currencyflag':'','symbol':'$'},
  'UZS':{'label':'Som Uzbêkistan','currencyflag':'','symbol':'Ð»Ð²'},
  'VEF':{'label':'BolÃ­var Vênêzuêla','currencyflag':'','symbol':'Bs F'},
  'VUV':{'label':'Vatu Vanuatu','currencyflag':'','symbol':'Vt'},
  'WST':{'label':'Tālā Samoa','currencyflag':'','symbol':'T'},
  'XAF':{'label':'Franc Trung Phi','currencyflag':'XAF','symbol':'Fr'},
  'XCD':{'label':'Đô la Đông Caribê','currencyflag':'XCD','symbol':'$'},
  'XOF':{'label':'Franc Tây Phi','currencyflag':'XOF','symbol':'Fr'},
  'XPF':{'label':'Franc CFP','currencyflag':'XPF','symbol':'Fr'},
  'YER':{'label':'Rial Yêmen','currencyflag':'','symbol':'ï·¼'},
  'ZAR':{'label':'Rand Nam Phi','currencyflag':'ZAR','symbol':'R'},
  'ZMW':{'label':'Kwacha Zambia','currencyflag':'','symbol':'ZK'},
  'ZWL':{'label':'Đô la Zimbabwe','currencyflag':'','symbol':'$'}
};
  ...
  BFHCountries.prototype = {
    ...
    addCountries: function () {
      ...
      if (this.options.blank === true) {
        this.$element.append('<option value="">--- Chọn ---</option>');
      }
...
+function ($) {
  ...
  BFHCurrencies.prototype = {
    ...
    addCurrencies: function () {
      ...
      for (currency in currencies) {
        if (currencies.hasOwnProperty(currency)) {
          this.$element.append('<option data-label="' + currencies[currency].label + '" value="' + currency + '">' + currency + " - " + currencies[currency].label + '</option>');
        }
      }
    ...
    addBootstrapCurrencies: function() {
      ...
      if (this.options.blank === true) {
        $options.append('<li><a tabindex="-1" href="#" data-option="">123</a></li>');
      }
